    ...
    <main>
      ...
      <section>
        <div class="suggest-content">
          ...
          <div class="option">
            <a href="<?php echo _DEFAULT_PATH ?>/movies"><h5>Popular</h5></a>
            <a href="<?php echo _DEFAULT_PATH ?>/movies/top"><h5>Top Rated</h5></a>
            <a href="<?php echo _DEFAULT_PATH ?>/movies/upcoming"><h5>Upcoming</h5></a>
            <a href="<?php echo _DEFAULT_PATH ?>/movies/genre"><h5>Movie Genres</h5></a>
          </div>
        </div>
      ...
      <div class="next-page">
        <div class="next-page-control">
          <?php
          if($page > 1 && $page <= 10){
            echo '<a href="'._DEFAULT_PATH.'/movies/'.$type.'/'.($page - 1).'"><i class="fa-solid fa-backward-step"></i></a>';
          }
          ...
          for($i = 1; $i <= 10; $i++){
            if($i == $page){
              ...
              echo '<a href="'._DEFAULT_PATH.'/movies/'.$type.'/'.$i.'"><div class="number-page">'.$i.'</div></a>';
            }
          }

          if($page < 10 && $page >= 1){
            echo '<a href="'._DEFAULT_PATH.'/movies/'.$type.'/'.($page + 1).'"><i class="fa-solid fa-forward-step"></i></a>';
          }
          ?>
        </div>
      </div>
